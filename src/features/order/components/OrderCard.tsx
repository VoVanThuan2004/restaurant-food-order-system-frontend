  ...
  return (
    <div className="bg-white rounded-xl border border-gray-300 shadow-md w-full px-5 py-4 mt-5 mx-auto">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Bàn 01</h2>
        <div
      ...
      <div className="flex items-center justify-between mt-2">
        <p className="text-gray-500 text-[16px]">Tiền nhận (Received)</p>
        <p className="text-[17px]">500.000VND</p>
      </div>

      {/* Tiền thối */}
      <div className="flex items-center justify-between mt-2">
        <p className="text-gray-500 text-[16px]">Tiền thối (Change)</p>
        <p className="text-[17px]">50.000VND</p>
      </div>

      {/* Tổng tiền */}
      <div className="flex items-center justify-between mt-3 mb-4">
        <p className="text-xl font-extrabold">Tổng tiền (Total)</p>
        <p className="text-xl text-red-500 font-extrabold">450.000VND</p>
      </div>
      ...
      <div className="flex items-center mt-3 gap-2">
        ...
        <p className="text-gray-500">Method: Cash</p>
      </div>

      {/* Thời gian thanh toán */}
      <div className="flex items-center mt-2 gap-2">
        <Clock className="text-gray-500" size={20} />
        <p className="text-gray-500">Time: 01/01/2026 12:00</p>
      </div>
