...
type Props = {
  isOpen: boolean;
  isLoading: boolean;
  dineTable: DineTableDTO;
  handleSubmit: (dineTable: DineTableUpdateDTO) => void;
  handleCancel: () => void;
};
...
const DineTableUpdateModal = (props: Props) => {
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({
      tableName: props.dineTable.tableName,
      quantity: props.dineTable.quantity,
    });
  }, [props.isOpen, props.dineTable, form]);
...
export default DineTableUpdateModal;
