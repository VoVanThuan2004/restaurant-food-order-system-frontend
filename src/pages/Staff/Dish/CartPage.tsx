...
export const CartPage = () => {
    ...
    const onPayOrder = async (paymentMethod: string, amountReceived: number) => {
        ...
        try {
            ...
            notification.error({
                message: "Lỗi",
                description: apiError.message || "Bị lỗi khi thanh toán, vui lòng thử lại sau",
            });
    ...
    const canPlaceOrder =
        orderDetail?.orderItems?.some((item) => item.currentStatus === "NEW") ?? false;

    const isEmpty = !orderDetail?.orderItems || orderDetail.orderItems.length === 0;
            ...
            <div className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="font-medium text-gray-900">{orderDetail?.diningTableName}</span>
                        <span className="text-sm text-gray-600 ml-4">Nhân viên:</span>
                        <span className="font-medium text-gray-900">{orderDetail?.staffName}</span>
                    ...
                    <>
                            ...
                            <div>
                                ...
                                <div className="sticky top-35 bg-white rounded-2xl shadow-lg border border-gray-100 p-6 space-y-4">
                                    ...
                                    <div className="space-y-3 pt-2">
                                        ...
                                        >
                                            {placeOrderMutation.isPending ? "Đang xử lý..." : "Tiến hành đặt món"}
                                        </Button>
                        ...
                        <div className="mt-12">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {[
                                    { id: 1, name: "Coca Cola", desc: "Nước ngọt có ga", price: 15000 },
                                    { id: 2, name: "Bia Tiger", desc: "Bia lạnh", price: 25000 },
                                    { id: 3, name: "Nước lạnh", desc: "Nước đá lạnh mát", price: 5000 },
                                ].map((item) => (
                                    <div
                                        key={item.id}
                                        className="bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition-all border border-gray-100 group"
                                    >
                                        <div className="h-32 bg-gradient-to-br from-gray-200 to-gray-300 rounded-lg mb-3 group-hover:from-gray-300 group-hover:to-gray-400 transition-colors" />
