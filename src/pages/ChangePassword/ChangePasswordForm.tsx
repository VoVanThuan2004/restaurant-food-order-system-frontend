...
const ChangePasswordForm = ({
  ...
  return (
    <div className="relative max-w-md md:max-w-xl w-full bg-white rounded-xl shadow-md mt-5 mx-auto py-5 px-4 md:px-8">
      {/* Overlay Loading */}
      {loading && (
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-white/70 backdrop-blur-[1px] rounded-xl">
